...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference('Cocktail.count') do
      post cocktails_url, params: { cocktail: { description: @cocktail.description, name: @cocktail.name, photo: @cocktail.photo } }
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { description: @cocktail.description, name: @cocktail.name, photo: @cocktail.photo } }
